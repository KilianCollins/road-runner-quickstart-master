package org.firstinspires.ftc.teamcode.drive.SemiArea.Auto;
...
@Autonomous(name = "BLUE RIGHT, detect prop")

public class CameraAutoBlueSAWrr extends LinearOpMode {
   ...
   /// Team6976HWMap drive_train = new Team6976HWMap();
    ...
    public void runOpMode() {
        ...
        BlueBlobDetectionPipelineSA blueBlobDetectionPipeline = new BlueBlobDetectionPipelineSA();
...
// spike left && prop not found y
    ...
    private void initOpenCV() {
        ...
        controlHubCam.setPipeline(new BlueBlobDetectionPipelineSA());
    ...
    class BlueBlobDetectionPipelineSA extends OpenCvPipeline {
